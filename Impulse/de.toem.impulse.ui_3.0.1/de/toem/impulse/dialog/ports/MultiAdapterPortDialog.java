...
public class MultiAdapterPortDialog
extends ControlProviderElementDialog {
    public MultiAdapterPortDialog(ITlkPartContainer parent, int style) {
        super(parent, MultiAdapterPortDialog.getControls(), style);
    }

    public MultiAdapterPortDialog() {
    }
    ...
    public static IControlProvider getControls() {
        ...
        provider.setCellClass(MultiAdapterPort.class);
        return provider;
    }
}
