...
namespace de.toem.flux.examples {
    export class Example09 {
        ...
        public static example() {
            ...
            let taVal : string[] = [null, null];
            let iaVal : number[] = [0, 0, 0, 0];
            let faVal : number[] = [0, 0];
            let eaVal : number[] = [0, 0, 0, 0, 0, 0, 0, 0];
            let buffer : de.toem.flux.Flx.Buffer = ;
            let trace : de.toem.flux.Flx.Trace = new de.toem.flux.Flx.Trace(0, Example09.MAX_ITEM_ID, Example09.MAX_ENTRY_SIZE, false, buffer);
            if (trace != null){
                ...
                trace.addSignal(5, 1, "text array", "2 elements", de.toem.flux.Flx.TYPE_TEXT_ARRAY, "default<dim=2>");
                ...
                members[3] = trace.createMember(3, "m3", de.toem.flux.Flx.STRUCT_TYPE_STRUCT, null);
                let innermembers : de.toem.flux.Flx.MemberValue[] = trace.createMembers(10);
                innermembers[0] = trace.createSubMember(10, 3, "i0", de.toem.flux.Flx.STRUCT_TYPE_LOCAL_ENUM, null);
                innermembers[1] = trace.createSubMember(11, 3, "i1", de.toem.flux.Flx.STRUCT_TYPE_INTEGER, "default<df=Dec>");
                innermembers[2] = trace.createSubMember(12, 3, "i2", de.toem.flux.Flx.STRUCT_TYPE_FLOAT, null);
                innermembers[3] = trace.createSubMember(13, 3, "i3", de.toem.flux.Flx.STRUCT_TYPE_FLOAT_ARRAY, null);
                innermembers[4] = trace.createSubMember(14, 3, "i4", de.toem.flux.Flx.STRUCT_TYPE_INTEGER_ARRAY, null);
                innermembers[5] = trace.createSubMember(15, 3, "i5", de.toem.flux.Flx.STRUCT_TYPE_ENUM_ARRAY, null);
                innermembers[6] = trace.createSubMember(16, 3, "i6", de.toem.flux.Flx.STRUCT_TYPE_TEXT_ARRAY, null);
                innermembers[7] = trace.createSubMember(17, 3, "i7", de.toem.flux.Flx.STRUCT_TYPE_TEXT, null);
                innermembers[8] = trace.createSubMember(18, 3, "i8", de.toem.flux.Flx.STRUCT_TYPE_BINARY, null);
                innermembers[9] = trace.createSubMember(19, 3, "i9", de.toem.flux.Flx.STRUCT_TYPE_STRUCT, null);
                let innerinnermembers : de.toem.flux.Flx.MemberValue[] = trace.createMembers(3);
                innerinnermembers[0] = trace.createSubMember(20, 19, "ii0", de.toem.flux.Flx.STRUCT_TYPE_LOCAL_ENUM, null);
                innerinnermembers[1] = trace.createSubMember(21, 19, "ii1", de.toem.flux.Flx.STRUCT_TYPE_INTEGER, "default<df=Dec>");
                innerinnermembers[2] = trace.createSubMember(22, 19, "ii2", de.toem.flux.Flx.STRUCT_TYPE_FLOAT, null);
                trace.open(0, "ns", 0, 0);
