...
namespace de.toem.flux.examples {
    export class Example10 {
        ...
        public static example() {
            ...
            let buffer2 : de.toem.flux.Flx.Buffer = ;
            let buffer1 : de.toem.flux.Flx.Buffer = new de.toem.flux.SimpleCompressionBuffer(Example10.MAX_ENTRY_SIZE, de.toem.flux.Flx.PACK_GZIP, buffer2);
            let trace : de.toem.flux.Flx.Trace = new de.toem.flux.Flx.Trace(0, Example10.MAX_ITEM_ID, Example10.MAX_ENTRY_SIZE, false, buffer2);
            if (trace != null){
