...
namespace de.toem.flux.examples {
    export class Example02 {
        ...
        public static example() {
            ...
            let iVal : number = 0;
            let fVal : number = 0.0;
            let buffer : de.toem.flux.Flx.Buffer = new Example02.MyBuffer(Example02.MAX_ENTRY_SIZE);
            let trace : de.toem.flux.Flx.Trace = new de.toem.flux.Flx.Trace(0, Example02.MAX_ITEM_ID, Example02.MAX_ENTRY_SIZE, false, buffer);
            if (trace != null){
    ...
    export namespace Example02 {
        ...
        export class MyBuffer extends de.toem.flux.Flx.SimpleBuffer {
