            ...
            (function (examples) {
                class Example06 {
                    static example() {
                        ...
                        let buffer = ;
                        let trace = new de.toem.flux.Flx.Trace(0, Example06.MAX_ITEM_ID, Example06.MAX_ENTRY_SIZE, false, buffer);
                        if (trace != null) {
                            trace.addHead("example", "flux example");
                            trace.addScope(1, 0, "Arrays", "Scope Description");
                            trace.addSignal(2, 1, "array of integers", "2/4 elements", de.toem.flux.Flx.TYPE_INTEGER_ARRAY, "default<dim=4>");
                            trace.addSignal(3, 1, "array of floats", "2 elements", de.toem.flux.Flx.TYPE_FLOAT_ARRAY, "default<dim=2>");
                            trace.addSignal(4, 1, "array of enums", "8 elements", de.toem.flux.Flx.TYPE_EVENT_ARRAY, "default<dim=8>");
                            trace.open(0, "ns", 0, 0);
                            ...
                            trace.writeEnumDef(4, de.toem.flux.Flx.ENUM_MEMBER_0 + 0, "Yes", 1);
                            trace.writeEnumDef(4, de.toem.flux.Flx.ENUM_MEMBER_0 + 0, "No", 0);
                            trace.writeEnumDef(4, de.toem.flux.Flx.ENUM_MEMBER_0 + 1, "Low", 1);
                            trace.writeEnumDef(4, de.toem.flux.Flx.ENUM_MEMBER_0 + 1, "High", 0);
