            ...
            (function (examples) {
                class Example10 {
                    static example() {
                        ...
                        let buffer2 = ;
                        let buffer1 = new de.toem.flux.SimpleCompressionBuffer(Example10.MAX_ENTRY_SIZE, de.toem.flux.Flx.PACK_GZIP, buffer2);
                        let trace = new de.toem.flux.Flx.Trace(0, Example10.MAX_ITEM_ID, Example10.MAX_ENTRY_SIZE, false, buffer2);
                        if (trace != null) {
