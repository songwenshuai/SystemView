            ...
            (function (Flx) {
                ...
                class Buffer {
                    ...
                    writeSectionEntries(noOfSections) {
                        ...
                        if (started >= de.toem.flux.Flx.OK) {
                            ...
                            let contentSize = sectionSize - de.toem.flux.Flx.SECTION_HEADER_SIZE;
                            let lastContentSize = avail - sectionSize * (noOfSections - 1) - de.toem.flux.Flx.SECTION_HEADER_SIZE;
                    ...
                    writeIntDataEntry(itemId, tag, delta, value) {
                        ...
                        let szDf = ((de.toem.flux.Flx.DF_DEFAULT | 0) | 0);
                    ...
                    writeIntArrayDataEntry(itemId, tag, delta, value, dynamicSize) {
                        ...
                        let szDf = (((dynamicSize ? de.toem.flux.Flx.DF_N_ARRAY : de.toem.flux.Flx.DF_DEFAULT) | Flx.intArrayXdf(value)) | 0);
                    ...
                    writeFloatDataEntry(itemId, tag, delta, value) {
                        ...
                        let vlength = Flx.length(vbytes);
                        let szDf = ((de.toem.flux.Flx.DF_DEFAULT | Flx.floatXdf(value)) | 0);
                        let request = Flx.plusLen(itemId) + (tag > 1 ? 1 : 0) + Flx.plusLen(delta) + Flx.plusLen((vlength << 4) | 15) + vlength;
                        let started = this.request(request);
                        if (started >= de.toem.flux.Flx.OK) {
                            let written = started;
                    ...
                    writeFloatArrayDataEntry(itemId, tag, delta, value, dynamicSize) {
                        ...
                        let szDf = (((dynamicSize ? de.toem.flux.Flx.DF_N_ARRAY : de.toem.flux.Flx.DF_DEFAULT) | Flx.floatArrayXdf(value)) | 0);
                        let addComponentSize = (szDf & de.toem.flux.Flx.XDF_FLOAT_BIG) === de.toem.flux.Flx.XDF_FLOAT_BIG;
                        let vlength = Flx.arrayLength(vbytes, dynamicSize, addComponentSize);
                        let request = Flx.plusLen(itemId) + (tag > 1 ? 1 : 0) + Flx.plusLen(delta) + Flx.plusLen((vlength << 4) | 15) + vlength;
                        let started = this.request(request);
                        if (started >= de.toem.flux.Flx.OK) {
                    ...
                    writeEventArrayDataEntry(itemId, tag, delta, value, dynamicSize) {
                        ...
                        let szDf = ((dynamicSize ? de.toem.flux.Flx.DF_N_ARRAY : de.toem.flux.Flx.DF_ENUM_EVENT) | 0);
                    ...
                    writeTextArrayDataEntry(itemId, tag, delta, value, dynamicSize) {
                        ...
                        let szDf = ((dynamicSize ? de.toem.flux.Flx.DF_N_ARRAY : de.toem.flux.Flx.DF_DEFAULT) | 0);
                        let vlength = Flx.arrayLength(vbytes, dynamicSize, true);
                        let request = Flx.plusLen(itemId) + (tag > 1 ? 1 : 0) + Flx.plusLen(delta) + Flx.plusLen((vlength << 4) | 15) + vlength;
                        let started = this.request(request);
                        if (started >= de.toem.flux.Flx.OK) {
                    ...
                    writeLogicStatesDataEntry(itemId, tag, delta, precedingStates, value, totalBitWidth) {
                        ...
                        vlength -= start;
                        let stateLevel = (maxState >= de.toem.flux.Flx.STATE_Z_BITS ? (maxState >= de.toem.flux.Flx.STATE_L_BITS ? de.toem.flux.Flx.STATE_LEVEL_16 : de.toem.flux.Flx.STATE_LEVEL_4) : de.toem.flux.Flx.STATE_LEVEL_2);
                        ...
                        if (started >= de.toem.flux.Flx.OK) {
                            ...
                            if (vlength === 0 && precedingStates === de.toem.flux.Flx.STATE_0_BITS) {
                                ...
                                if (stateLevel === de.toem.flux.Flx.STATE_LEVEL_2) {
                                    fill = (de.toem.flux.Flx.LOGIC_L2_BYTE_FILL_$LI$()[precedingStates] | 0);
                                    ...
                                    fill = (de.toem.flux.Flx.LOGIC_L4_BYTE_FILL_$LI$()[precedingStates] | 0);
                                    ...
                                    fill = (de.toem.flux.Flx.LOGIC_L16_BYTE_FILL_$LI$()[precedingStates] | 0);
                ...
                class MemberValue {
                    ...
                    pack() {
                        ...
                        let baseType = ((this.type & de.toem.flux.Flx.STRUCT_TYPE_MASK_BASE) | 0);
                        if (baseType === de.toem.flux.Flx.STRUCT_TYPE_GLOBAL_ENUM || baseType === de.toem.flux.Flx.STRUCT_TYPE_LOCAL_ENUM || baseType === de.toem.flux.Flx.STRUCT_TYPE_MERGE_ENUM || baseType === de.toem.flux.Flx.STRUCT_TYPE_INTEGER) {
                            ...
                            xdf = (((Flx.intArrayXdf(this.value) << 2) & de.toem.flux.Flx.STRUCT_MASK_XDF) | 0);
                        }
                            ...
                            xdf = (((xdf << 2) & de.toem.flux.Flx.STRUCT_MASK_XDF) | 0);
                        }
                            ...
                            if (this.value != null && this.value instanceof Array && (this.value.length == 0 || this.value[0] == null || this.value[0] != null && this.value[0] instanceof de.toem.flux.Flx.MemberValue)) {
                                let vlength = 0;
                ...
                class Trace extends Flx.TraceItem {
                    ...
                    addHead(name, description) {
                        ...
                        return this.buffer.writeHeadEntry("flux", this.id, name, description, (de.toem.flux.Flx.MODE_HEAD_NORMAL | 0), this.maxItemId, this.maxEntrySize);
                    }
                    /**
                     * Writes a head entry. The head entry contains information data about the trace and is also used as file identification.
                     * @param {string} name : The name of the item
                    ...
                    addHeadDerived(format4, name, description) {
                        ...
                        return this.buffer.writeHeadEntry(format4, this.id, name, description, (de.toem.flux.Flx.MODE_HEAD_NORMAL | 0), this.maxItemId, this.maxEntrySize);
                    }
                    /**
