...
public class MultiLinePaintPlanner
extends MultiPaintPlanner {
    public MultiLinePaintPlanner(ITheme theme, List<? extends IPlotItem> plannables, IDomainAxis axis, Rectangle area, int style) {
