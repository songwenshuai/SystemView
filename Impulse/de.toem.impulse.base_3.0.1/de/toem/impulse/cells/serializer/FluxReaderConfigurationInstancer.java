...
public class FluxReaderConfigurationInstancer
extends AbstractDefaultInstancer {
    @Override
    public String getCellType() {
        return "impulse.serializer.configuration.flux";
    }

    @Override
    protected void initOne(String id, ICell cell, IElement preferences) {
        cell.setValue("script", (Object)Scripting.loadScriptFromResources(FluxReaderConfigurationInstancer.class, "fluxReader.js"));
    }
}
